...
class Review(TypedDict):
    key_themes: Annotated[list[str], "list all key themes mentioned in the review"]
    summary: Annotated[str, "Brief Summary of the review"]
    sentiment: Annotated[Literal["POS", "NEG", "MIX"], "Sentiment of the review either positive, negative or mixed"]
    pros: Annotated[Optional[list[str]], "List down all the pros mentioned"]
    cons: Annotated[Optional[list[str]], "List down all the cons mentioned"]
